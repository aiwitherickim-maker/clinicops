/* Lucide-style stroke icons for ClinicOps. */
...
const IconMessageCircle = (p) => (<Icon {...p}><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/></Icon>);
...
const IconShieldCheck = (p) => (<Icon {...p}><path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"/><path d="m9 12 2 2 4-4"/></Icon>);
const IconUserCheck = (p) => (<Icon {...p}><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><polyline points="17 11 19 13 23 9"/></Icon>);
const IconAlert = (p) => (<Icon {...p}><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"/><path d="M12 9v4"/><path d="M12 17h.01"/></Icon>);
const IconCheckCircle = (p) => (<Icon {...p}><circle cx="12" cy="12" r="10"/><path d="m9 12 2 2 4-4"/></Icon>);
...
const IconSparkles = (p) => (<Icon {...p}><path d="M12 3l1.7 4.5L18 9l-4.3 1.5L12 15l-1.7-4.5L6 9l4.3-1.5z"/><path d="M19 14l.9 2.4L22 17l-2.1.6L19 20l-.9-2.4L16 17l2.1-.6z"/></Icon>);
const IconEye = (p) => (<Icon {...p}><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></Icon>);
const IconPill = (p) => (<Icon {...p}><path d="M10.5 20.5a4.95 4.95 0 1 1-7-7l7-7a4.95 4.95 0 1 1 7 7l-7 7z"/><path d="m8.5 8.5 7 7"/></Icon>);
...
const IconBuilding = (p) => (<Icon {...p}><rect width="16" height="20" x="4" y="2" rx="2"/><path d="M9 22v-4h6v4"/><path d="M8 6h.01"/><path d="M16 6h.01"/><path d="M12 6h.01"/><path d="M12 10h.01"/><path d="M8 10h.01"/><path d="M16 10h.01"/><path d="M12 14h.01"/><path d="M8 14h.01"/><path d="M16 14h.01"/></Icon>);
...
const IconRoute = (p) => (<Icon {...p}><circle cx="6" cy="19" r="3"/><path d="M9 19h8.5a3.5 3.5 0 0 0 0-7h-11a3.5 3.5 0 0 1 0-7H15"/><circle cx="18" cy="5" r="3"/></Icon>);
...
const IconLightbulb = (p) => (<Icon {...p}><path d="M9 18h6"/><path d="M10 22h4"/><path d="M12 2a7 7 0 0 0-4 12.7c.6.4 1 1 1 1.7v.6h6v-.6c0-.7.4-1.3 1-1.7A7 7 0 0 0 12 2z"/></Icon>);
...
const IconRotate = (p) => (<Icon {...p}><path d="M3 12a9 9 0 1 0 3.3-6.9L3 8"/><path d="M3 3v5h5"/></Icon>);
...
Object.assign(window, {
  Icon,
  IconBot, IconLayout, IconMessageCircle, IconInbox, IconTerminal, IconCheckSquare,
  IconSettings, IconShieldCheck, IconUserCheck, IconAlert, IconCheckCircle, IconClose,
  IconSearch, IconBell, IconArrowRight, IconSend, IconSparkles, IconEye, IconPill,
  IconCalendar, IconDollar, IconFile, IconBuilding, IconUsers, IconBook, IconLock,
  IconRoute, IconClock, IconClipboard, IconClipboardCheck, IconRefresh, IconChevronDown,
  IconPlus, IconFilter, IconEdit, IconArrowUp, IconStethoscope, IconUser, IconFlag,
  IconLightbulb, IconActivity, IconChevronRight, IconMoreH, IconRotate, IconLayers,
});
