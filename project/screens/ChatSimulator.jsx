/* Patient Chat Simulator — left: white-labeled patient chat. right: agent workflow result. */

function ChatSimulator() {
  const seed = SIM_CONVERSATIONS[0];
  const [messages, setMessages] = React.useState(seed.initialMessages);
  const [workflow, setWorkflow] = React.useState(seed.workflow);
    ...
    <div className="screen-enter" style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div className="page-header">
        ...
        <div className="actions">
          <Button variant="secondary" size="sm"><IconRefresh size={14} /> Reset conversation</Button>
...
function AgentWorkflowResult({ wf, visible, running }) {
  return (
    <div className="card">
          ...
          <div className="agent-panel">
            ...
            <AgentStep
              ...
              kv={[
                ...
                { k: "Route to",     v: wf.safety.routeTo, warn: false },
              ]}
            />
            <AgentStep
...
Object.assign(window, { ChatSimulator });
